...
Atualmente, venho aprofundando meus estudos em **Python** e **Django**, além de estar começando a estudar **React** para expandir minha stack e atuar de forma mais completa no desenvolvimento de aplicações web.
...
![Caching](https://img.shields.io/badge/Caching-FF6F00?style=for-the-badge&logo=redis&logoColor=white)
![Rate Limiting](https://img.shields.io/badge/Rate%20Limiting-4B5563?style=for-the-badge&logo=fastapi&logoColor=white)
...
- Arquitetura backend e boas práticas
...
Tenho interesse em construir aplicações web completas, com backend robusto, APIs bem documentadas e integração com tecnologias modernas.
